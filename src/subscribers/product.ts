...
// 	handleProductCreation = async (
// 		data
// 	) => {
// 		this.logger_.info(
// 			"Algolia util Handling product creation"
// 		);
// 		try {
// 			const product =
// 				await this.productService_.retrieve(
// 					data.id,
// 					{
...
// 			this.logger_.info(
// 				"Added 1 product to search index"
// 			);
// 		} catch (error) {
// 			this.logger_.error(
// 				"Failed adding product to search index",
// 				error
// 			);
// 		}
// 	};
...
// 	): Promise<any> => {
// 		this.logger_.info(
// 			"Algolia util Handling product update"
// 		);
// 		try {
// 			const { id } = data;
// 			const product =
...
// 			) {
// 				this.logger_.info(
// 					"Removing product from index because it was unpublished"
// 				);
...
// 				);
// 				this.logger_.info(
// 					"Published 1 product to search index"
// 				);
// 			}
// 		} catch (error) {
// 			this.logger_.error(
// 				"Failed to update product to search index",
// 				error
// 			);
// 		}
...
// 	handleProductDeletion = async (
// 		data
// 	) => {
// 		this.logger_.info(
// 			"Algolia util Handling product deletion"
// 		);
// 		try {
// 			await this.searchService_.deleteDocument(
// 				ProductService.IndexName,
...
// 		} catch (error) {
// 			this.logger_.error(
// 				"Failed to remove product from index",
// 				error
// 			);
// 		}

// 		this.logger_.info(
// 			"Removed product from search index"
// 		);
// 	};

// 	handleProductVariantChange = async (
// 		data
// 	) => {
// 		this.logger_.info(
// 			"Algolia util Handling product variant change"
// 		);
// 		try {
// 			const product =
// 				await this.productService_.retrieve(
...
// 			this.logger_.info(
// 				"Updated product in search index for variant update"
// 			);
// 		} catch (error) {
// 			this.logger_.error(
// 				"Failed to update search index for variant update",
// 				error
// 			);
// 		}
// 	};
